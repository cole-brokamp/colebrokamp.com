...
Leveraging my innovative exposure assessment and data linkage methods, I led the first study to quantify the impact of substandard housing conditions on pediatric health at an address-specific level.

```{r}
#| results: asis
cite_four(c("brokamp-2025", "brokamp-2024", "zanobetti-2022", "ryan-2024"))
```
