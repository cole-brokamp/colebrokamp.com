...
\vspace*{.05in}  
\begin{list2}
\item BE-XXX Computational Statistics using R Shiny, Fall 2015.
\end{list2}



\section{\sc Publications}
\include{publications-content}


\section{\sc Conference Presentations}
\begin{list1} \itemsep 4pt
...
\item[] \textit{Languages:} Python, Unix shell scripting, Max
...
\item[] A package for R that covers my commonly used personal functions. Includes data exploration functions common to epidemiologic studies. Available at \texttt{https://github.com/cole-brokamp/CB}.
\end{list1}
