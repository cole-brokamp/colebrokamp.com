...
I look forward to contributing as a consultant for the NEXUS: Network for Exposomics in the U.S Center under the leadership of Chirag Patel, Rima Habre, and Gary Miller and in response to RFA-ES-23-010-Center for Exposome Research Coordination to Accelerate Precision Environmental Health. I am excited about the NEXUS network's organization around four complementary hubs: ChemBio Analytical Sciences, Geospatial Science, Data Science, and Administration / Stakeholder Engagement. As a researcher with expertise in geospatial science, I look forward to participating in the Geospatial Science hub under your co-directorship. I will contribute to your plan to develop best practices for using geospatial technologies and methods to assess, link, and analyze the physical, chemical, built, natural, and social environment for exposomics.


```{r}
#| results: asis
cite_four(c("rasnick-2023", "zanobetti-2022", "brokamp-2022", "brokamp-2017b"))
```
