...
In addition to statistical and epidemiologic methodological developments, I have also contributed as the lead biostatistician in other biomedical clinical and observational studies. I look forward to contributing as a consultant and biostatistician to your proposed R01 project as a part of our ongoing collaborations, which includes NIH-funded awards and co-mentorship of your postdoctoral research fellow. My experience and expertise in data processing, statistical methods, as well as analyses interpretation will contribute to the success of this proposed project. 

```{r}
#| results: asis
cite_four(c("zundel-2022", "vancil-2022", "hartley-2020", "gecili-2023"))
```
