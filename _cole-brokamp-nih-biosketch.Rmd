...
I look forward to working with Drs. Marusak, Rabinak, and Lundahl in their pursuit of a novel pharmacological intervention for enhancing cognitive behavioral therapy in adults with generalied anxiety disorder (GAD). I have collaborated previously with Dr. Marusak on anxiety disorders and the role of the environment.  I lead a research study to studying the change in symptom severity among children and adolescents with GAD related to daily changes in air pollution. I have also contributed as the lead biostatistician in other biomedical clinical and observational studies. My biostatistical and epidemiological expertise and experience has helped me contribute to the design of their studies and will help me to address the go criterion for the progression from R61 to R33 and to assess the efficacy of CBD administration during and after CBT treatment

```{r}
#| results: asis
cite_four(c("zundel-2022", "vancil-2022", "turner-2022a", "turner-2022"))
```
