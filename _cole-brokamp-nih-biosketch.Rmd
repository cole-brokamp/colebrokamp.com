...
yaml::yaml.load_file("data/support.yaml") |>
  purrr::keep_at(c("tes-r01", "degauss-r01", "beck-riseup", "c4", "brunst-epigenetics")) |>
  purrr::map_chr(make_support_entry) |>
  cat(sep = "\n\n")
```

Peer-review publications I would like to highlight include:

```{r}
#| results: asis
cite_four(c("colegate-2024", "pennington-2022", "brokamp-2024", "wolfe-2020"))
```
...
```{r}
#| results: asis
cite_four(c("brokamp-2022", "brokamp-2018", "brokamp-2017"))
```
