...
Perhaps the most useful feature to users at CCHMC is that the process is [HIPAA](http://www.hhs.gov/hipaa/for-professionals/privacy/laws-regulations/) compliant.  Geocoding is completed on a server inside the CCHMC network without using internet access. 
...
If you use any geocoding results in a scientific publication, please cite the use of this software. The DOI number and example citations are located at [http://doi.org/10.5281/zenodo.344621](http://doi.org/10.5281/zenodo.344621).